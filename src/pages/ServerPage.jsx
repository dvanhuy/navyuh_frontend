...
import { indexMessages, sendMessages } from "../services/messageServices";
                    ...
                    }
                    {
                        ...
                        if (message.type === 'images') {
                            return user.id === message.sender_id ? (
                                <ImageSend key={index} images={message?.message_images} />
                            ) : (
                                <ImageReceive key={index} images={message?.message_images} />
                            );
                        } else {
                            return user.id === message.sender_id ? (
                                <MessageSend key={index}>{message.content}</MessageSend>
                            ) : (
                                <MessageReceive key={index}>{message.content}</MessageReceive>
                            );
                        }
                    })}
                </div>
                <MessageField sendMessage={handleSendMessage} enable={sendable}/>
            </div>
